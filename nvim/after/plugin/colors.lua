function set_colors(color)
  ...
  vim.cmd("highlight DiagnosticUnderlineError gui=underline guifg=#f44747")
  vim.cmd("highlight DiagnosticUnderlineWarn gui=underline guifg=#ffe88b")
  vim.cmd("highlight DiagnosticUnderlineInfo gui=underline guifg=#0a7aca")
  vim.cmd("highlight DiagnosticUnderlineHint gui=underline guifg=#0a7aca")
  ...
  vim.cmd("highlight SpecialChar guibg=NONE guifg=#d7ba7d")
end
set_colors()
