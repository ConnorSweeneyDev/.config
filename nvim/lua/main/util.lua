...
Buffer_util.set_targets = function(folders, file_extensions, ignore_patterns)
...
Lualine_util.dynamic_path = function()
  ...
  elseif string.find(path, "diffview://null") then
    path = "diffview\\null"
  ...
  elseif string.find(path, ".git/:3:/") or string.find(path, ".git//:3:") then
    path = "diffview\\theirs"
  elseif string.find(path, "claude%-prompt%-") then
    path = "claude"
