...
map("n", "<LEADER>v", "<CMD>!sh script/clean.sh -wezterm<CR>")
map("n", "<LEADER>b", "<CMD>!sh script/build.sh -wezterm<CR>")
map("n", "<LEADER>n", "<CMD>!sh script/run.sh -wezterm<CR>")
map("n", "<LEADER>m", "<CMD>!sh script/debug.sh -wezterm<CR>")
