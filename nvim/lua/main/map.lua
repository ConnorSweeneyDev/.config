...
vim.keymap.set("v", "J", "<ESC>gv<CMD>'<,'>m '>+1<CR>gv=gv", { desc = "Move the highlighted lines down" })
vim.keymap.set("v", "K", "<ESC>gv<CMD>'<,'>m '<-2<CR>gv=gv", { desc = "Move the highlighted lines up" })
...
vim.keymap.set({ "n", "v" }, "<LEADER>C", [["_C]], { desc = "Change without copying" })
vim.keymap.set("n", "g>", "<CMD>messages<CR>", { desc = "Show session messages" })
