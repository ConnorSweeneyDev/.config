...
vim.keymap.set("n", "J", "mzJ`z", { desc = "Concatenate the line below to the end of the current line" })
vim.keymap.set("n", "gJ", "mzgJ`z", { desc = "Concatenate the line below to the end of the current line without a space" })
...
vim.keymap.set({ "n", "v" }, "<LEADER>C", [["_C]], { desc = "Change without copying" })
vim.keymap.set("n", "<LEADER>s", ":%s/<C-r><C-w>/<C-r><C-w>", { desc = "Replace word under cursor in the current buffer" })
