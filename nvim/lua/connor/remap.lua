...
vim.keymap.set("n", "<LEADER>v", "<CMD>!clean.bat<CR>")
vim.keymap.set("n", "<LEADER>b", "<CMD>!build.bat<CR>")
vim.keymap.set("n", "<LEADER>n", "<CMD>!run.bat<CR>")
vim.keymap.set("n", "<LEADER>m", "<CMD>!debug.bat<CR>")
