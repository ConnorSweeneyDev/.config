...
vim.keymap.set("n", "<LEADER>v", "<CMD>!./scripts/clean.bat<CR>")
vim.keymap.set("n", "<LEADER>b", "<CMD>!./scripts/build.bat<CR>")
vim.keymap.set("n", "<LEADER>n", "<CMD>!./scripts/run.bat<CR>")
vim.keymap.set("n", "<LEADER>m", "<CMD>!./scripts/debug.bat<CR>")
