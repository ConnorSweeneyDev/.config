...
vim.keymap.set("n", "<LEADER>gr", "<CMD>!git restore %<CR>", { desc = "Git restore the current file" })
vim.keymap.set("n", "<LEADER>gR", "<CMD>!git restore .<CR>", { desc = "Git restore the current directory" })
vim.keymap.set(
  "n",
  "<C-g>",
