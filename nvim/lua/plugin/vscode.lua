...
Color_util.initialize("vscode", {
  ...
  DiagnosticHint = { guibg = "none", guifg = "#4ec9b0" },
  DiagnosticUnnecessary = { gui = "underline" },
  DiagnosticDeprecated = { guifg = "#c586c0", guisp = "#c586c0", gui = "underline" },
  DiagnosticUnderlineError = { guifg = "#f44747", guisp = "#f44747", gui = "underline" },
  DiagnosticUnderlineWarn = { guifg = "#ffe88b", guisp = "#ffe88b", gui = "underline" },
  DiagnosticUnderlineInfo = { guifg = "#0a7aca", guisp = "#0a7aca", gui = "underline" },
  DiagnosticUnderlineHint = { guifg = "#4ec9b0", guisp = "#4ec9b0", gui = "underline" },
  SpellBad = { guisp = "#f44747", gui = "underline" },
  SpellCap = { guisp = "#ffe88b", gui = "underline" },
  SpellRare = { guisp = "#4ec9b0", gui = "underline" },
  SpellLocal = { guisp = "#0a7aca", gui = "underline" },
